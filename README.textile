...
* include/defn.lfe
** Simplified, functional alternatives to @defun@ and @lambda@.
* include/using.lfe
...
* include/pointless.lfe
** Point-free function composition via @(-> e1 e2 ...)@ macro. Provides a Unix pipe-like syntax, with flexible currying.
* include/in.lfe
** Reversed @(in exp [b1 (...) b2 (...)])@ variant of @let*@. Focuses in composing functions, rather than sequencing side effects.
